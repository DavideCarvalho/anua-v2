...
export const controllers = {
  ...
  academicSubPeriods: {
    ...
    Store: () => import('#controllers/academic_sub_periods/store'),
    Update: () => import('#controllers/academic_sub_periods/update'),
  },
  achievements: {
  ...
  ai: {
    ...
    SubmitCanvas: () => import('#controllers/ai/submit_canvas_controller'),
  },
  analytics: {
  ...
  api: {
    game: {
      CreateGameCharacter: () => import('#controllers/api/game/create_game_character_controller'),
    },
  },
  asaas: {
  ...
  assignments: {
    ...
    ListAssignmentHistory: () => import('#controllers/assignments/list_assignment_history_controller'),
  ...
  canteenFinancialSettings: {
    ...
    UpdateCanteenFinancialSettings: () => import('#controllers/canteen_financial_settings/update_canteen_financial_settings_controller'),
  },
  canteenItems: {
    ...
    ListCanteenItemCategories: () => import('#controllers/canteen_items/list_canteen_item_categories_controller'),
  ...
  canteenMealReservations: {
    ...
    GetMealReservationCounts: () => import('#controllers/canteen_meal_reservations/get_meal_reservation_counts_controller'),
  ...
  canteens: {
    ...
    GenerateRecurrenceReservations: () => import('#controllers/canteens/generate_recurrence_reservations_controller'),
    ListCanteenMealRecurrences: () => import('#controllers/canteens/list_canteen_meal_recurrences_controller'),
    ListCanteens: () => import('#controllers/canteens/list_canteens_controller'),
    ListMealRecurrencesBySchools: () => import('#controllers/canteens/list_meal_recurrences_by_schools_controller'),
  ...
  dashboard: {
    ...
    GetPedagogicalAlerts: () => import('#controllers/dashboard/get_pedagogical_alerts_controller'),
    GetResponsavelAlerts: () => import('#controllers/dashboard/get_responsavel_alerts_controller'),
  ...
  escola: {
    ...
    ListInquiries: () => import('#controllers/escola/list_inquiries_controller'),
    MarkInquiryRead: () => import('#controllers/escola/mark_inquiry_read_controller'),
    ResolveInquiry: () => import('#controllers/escola/resolve_inquiry_controller'),
    ShowInquiry: () => import('#controllers/escola/show_inquiry_controller'),
  },
  eventParticipants: {
  ...
  exams: {
    ...
    ListExamHistory: () => import('#controllers/exams/list_exam_history_controller'),
  ...
  grades: {
    ...
    GetGradeTrends: () => import('#controllers/grades/get_grade_trends_controller'),
  ...
  pages: {
    ...
    aluno: {
      ShowAlunoAtividadesPage: () => import('#controllers/pages/aluno/show_aluno_atividades_page_controller'),
      ShowAlunoAutorizacoesPage: () => import('#controllers/pages/aluno/show_aluno_autorizacoes_page_controller'),
      ShowAlunoCalendarioPage: () => import('#controllers/pages/aluno/show_aluno_calendario_page_controller'),
      ShowAlunoCantinaPage: () => import('#controllers/pages/aluno/show_aluno_cantina_page_controller'),
      ShowAlunoCarrinhoPage: () => import('#controllers/pages/aluno/show_aluno_carrinho_page_controller'),
      ShowAlunoComunicadosPage: () => import('#controllers/pages/aluno/show_aluno_comunicados_page_controller'),
      ShowAlunoDashboardPage: () => import('#controllers/pages/aluno/show_aluno_dashboard_page_controller'),
      ShowAlunoDocumentosPage: () => import('#controllers/pages/aluno/show_aluno_documentos_page_controller'),
      ShowAlunoFazendinhaPage: () => import('#controllers/pages/aluno/show_aluno_fazendinha_page_controller'),
      ShowAlunoFinanceiroPage: () => import('#controllers/pages/aluno/show_aluno_financeiro_page_controller'),
      ShowAlunoFrequenciaPage: () => import('#controllers/pages/aluno/show_aluno_frequencia_page_controller'),
      ShowAlunoHorarioPage: () => import('#controllers/pages/aluno/show_aluno_horario_page_controller'),
      ShowAlunoIdlePage: () => import('#controllers/pages/aluno/show_aluno_idle_page_controller'),
      ShowAlunoJogoPage: () => import('#controllers/pages/aluno/show_aluno_jogo_page_controller'),
      ...
      ShowAlunoMatriculaPage: () => import('#controllers/pages/aluno/show_aluno_matricula_page_controller'),
      ShowAlunoNotasPage: () => import('#controllers/pages/aluno/show_aluno_notas_page_controller'),
      ShowAlunoOcorrenciasPage: () => import('#controllers/pages/aluno/show_aluno_ocorrencias_page_controller'),
    ...
    escola: {
      ...
      ShowCantinaRecorrenciasPage: () => import('#controllers/pages/escola/show_cantina_recorrencias_page_controller'),
      ...
      ShowEditarComunicadoPage: () => import('#controllers/pages/escola/show_editar_comunicado_page_controller'),
      ...
      ShowNovoComunicadoPage: () => import('#controllers/pages/escola/show_novo_comunicado_page_controller'),
      ...
      ShowPedagogicoCalendarioPage: () => import('#controllers/pages/escola/show_pedagogico_calendario_page_controller'),
      ShowPerguntaDetailPage: () => import('#controllers/pages/escola/show_pergunta_detail_page_controller'),
      ShowPerguntasPage: () => import('#controllers/pages/escola/show_perguntas_page_controller'),
    ...
    responsavel: {
      ...
      ShowResponsavelCalendarioPage: () => import('#controllers/pages/responsavel/show_responsavel_calendario_page_controller'),
      ...
      ShowResponsavelPerguntasPage: () => import('#controllers/pages/responsavel/show_responsavel_perguntas_page_controller'),
    },
  ...
  pedagogicalCalendar: {
    GetCreationContext: () => import('#controllers/pedagogical_calendar/get_creation_context_controller'),
    ListPedagogicalCalendar: () => import('#controllers/pedagogical_calendar/list_pedagogical_calendar_controller'),
  },
  platformSettings: {
  ...
  responsavel: {
    AcknowledgeComunicado: () => import('#controllers/responsavel/acknowledge_comunicado_controller'),
    ...
    GetStudentCalendar: () => import('#controllers/responsavel/get_student_calendar_controller'),
    ...
    ListComunicados: () => import('#controllers/responsavel/list_comunicados_controller'),
    ListPendingAcknowledgements: () => import('#controllers/responsavel/list_pending_acknowledgements_controller'),
    ListStudentInquiries: () => import('#controllers/responsavel/list_student_inquiries_controller'),
    ListStudentMealRecurrence: () => import('#controllers/responsavel/list_student_meal_recurrence_controller'),
    MarkInquiryRead: () => import('#controllers/responsavel/mark_inquiry_read_controller'),
    ResolveInquiry: () => import('#controllers/responsavel/resolve_inquiry_controller'),
    ShowComunicado: () => import('#controllers/responsavel/show_comunicado_controller'),
  ...
  schoolAnnouncements: {
    CreateSchoolAnnouncement: () => import('#controllers/school_announcements/create_school_announcement_controller'),
    DeleteSchoolAnnouncement: () => import('#controllers/school_announcements/delete_school_announcement_controller'),
    ListSchoolAnnouncementStudents: () => import('#controllers/school_announcements/list_school_announcement_students_controller'),
    ListSchoolAnnouncements: () => import('#controllers/school_announcements/list_school_announcements_controller'),
    PublishSchoolAnnouncement: () => import('#controllers/school_announcements/publish_school_announcement_controller'),
    ShowSchoolAnnouncement: () => import('#controllers/school_announcements/show_school_announcement_controller'),
    UpdateSchoolAnnouncement: () => import('#controllers/school_announcements/update_school_announcement_controller'),
  },
  schoolChains: {
  ...
  studentFarms: {
    ClaimDailySeeds: () => import('#controllers/student_farms/claim_daily_seeds_controller'),
    HarvestPlot: () => import('#controllers/student_farms/harvest_plot_controller'),
    PlantPlot: () => import('#controllers/student_farms/plant_plot_controller'),
  },
