      ...
      <Card>
        ...
        <CardContent className="space-y-1 text-sm">
          ...
          <p>
            ...
            {formatCurrency(data.billing.monthlyFee)}
            {data.billing.discountPercentage > 0 && (
              <span className="text-muted-foreground">
                {' '}
                ({data.billing.discountPercentage}% desconto)
              </span>
            )}
          </p>
          <p>
          ...
          {data.billing.enrollmentFee > 0 && (
            <p>
              <span className="text-muted-foreground">Taxa de matrícula:</span>{' '}
              {formatCurrency(data.billing.enrollmentFee)}
              {data.billing.enrollmentDiscountPercentage > 0 && (
                <span className="text-muted-foreground">
                  {' '}
                  ({data.billing.enrollmentDiscountPercentage}% desconto)
                </span>
              )}
            </p>
          )}
