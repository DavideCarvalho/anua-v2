...
export function AcademicOverviewCards({ academicPeriodId, classId }: AcademicOverviewCardsProps) {
  ...
  const query = { academicPeriodId, classId, subPeriodId: subPeriodId || undefined }
...
function AcademicOverviewCardsContent({ academicPeriodId, classId, subPeriodId }: AcademicOverviewCardsProps & { subPeriodId: string }) {
  const { data, isLoading } = useQuery(
    api.api.v1.grades.academicOverview.queryOptions({
      query: { academicPeriodId, classId, subPeriodId: subPeriodId || undefined },
    } as any)
  )
