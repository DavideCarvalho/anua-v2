...
export function ContractForm({ schoolId, academicPeriods, initialData }: ContractFormProps) {
          ...
          <CardContent className="pt-6">
            <Tabs defaultValue="basic" className="space-y-6">
              <TabsList>
                ...
                <TabsTrigger value="fees">Juros e Descontos</TabsTrigger>
              </TabsList>
