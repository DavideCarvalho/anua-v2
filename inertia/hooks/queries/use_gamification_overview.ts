...
const resolveRoute = () => tuyau.resolveRoute()('api.v1.analytics.gamification.overview')
...
export function useGamificationOverviewQueryOptions(query: GamificationOverviewQuery = {}) {
  return {
    ...
    queryFn: () => {
      return tuyau.resolveRoute()('api.v1.analytics.gamification.overview').$get({ query }).unwrap()
    },
