...
const resolveRoute = () => tuyau.resolveRoute()('api.v1.analytics.attendance.overview')
...
export function useAttendanceOverviewQueryOptions(query: AttendanceOverviewQuery = {}) {
  return {
    ...
    queryFn: () => {
      return tuyau.resolveRoute()('api.v1.analytics.attendance.overview').$get({ query }).unwrap()
    },
