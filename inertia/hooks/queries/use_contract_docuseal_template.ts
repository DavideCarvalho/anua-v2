...
const resolveRoute = () => tuyau.resolveRoute()('api.v1.contracts.getDocusealTemplate')
...
export function useContractDocusealTemplateQueryOptions(contractId: string) {
  ...
  return {
    ...
    queryFn: () => {
      return tuyau.resolveRoute()('api.v1.contracts.getDocusealTemplate', params).$get().unwrap()
    },
