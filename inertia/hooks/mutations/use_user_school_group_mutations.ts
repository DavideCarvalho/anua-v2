...
const resolveCreateRoute = () => tuyau.$route('api.v1.userSchoolGroups.createUserSchoolGroup')
type CreateUserSchoolGroupPayload = InferRequestType<ReturnType<typeof resolveCreateRoute>['$post']>
