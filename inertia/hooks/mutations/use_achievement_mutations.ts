...
const resolveCreateRoute = () => tuyau.$route('api.v1.achievements.store')
type CreateAchievementPayload = InferRequestType<ReturnType<typeof resolveCreateRoute>['$post']>

const resolveUpdateRoute = () => tuyau.$route('api.v1.achievements.update')
type UpdateAchievementPayload = InferRequestType<ReturnType<typeof resolveUpdateRoute>['$put']> & {
  id: string
}
