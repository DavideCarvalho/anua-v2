    ...
    <EscolaLayout>
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">Configure a grade de horários e disciplinas</p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {!isSchoolTeacher && (
            <Card className="hover:shadow-md transition-shadow">
              <CardHeader>
                ...
                <CardDescription>Configurar horários das aulas por turma</CardDescription>
              </CardHeader>
              <CardContent>
                <Link
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Vincular disciplinas às turmas</CardDescription>
            </CardHeader>
            <CardContent>
              <Link
          ...
          <Card className="hover:shadow-md transition-shadow">
            <CardHeader>
              ...
              <CardDescription>Visualizar grade completa da escola</CardDescription>
            </CardHeader>
            <CardContent>
              <Link
