        ...
        <CardContent>
          ...
          <div className="border-t pt-4 space-y-4">
            <form onSubmit={form.handleSubmit(onSendMessage)} className="space-y-3">
              <Textarea placeholder="Digite sua mensagem..." rows={3} {...form.register('body')} />
...
export default function PerguntaDetailPage() {
  const page = usePage<SharedProps & { inquiryId?: string; params?: { inquiryId?: string } }>()
  const inquiryId = page.props.inquiryId ?? page.props.params?.inquiryId
    ...
    return (
      <ResponsavelLayout>
        ...
        <Card>
          <CardContent className="py-12 text-center">
            <XCircle className="mx-auto h-12 w-12 text-destructive" />
            <h3 className="mt-4 text-lg font-semibold">Conversa não encontrada</h3>
            <p className="mt-2 text-sm text-muted-foreground">
