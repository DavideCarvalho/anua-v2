# Anuá Demo Video Design

## Overview

A 60-90 second sales demo video for school administrators, showcasing Anuá's AI-powered school management system.

## Target Audience

School decision-makers (directors, administrators) who are experiencing pain from manual, time-consuming admin work.
...
- Subtle floating motion on UI panels
...
- **FPS**: 30
- **Duration**: ~2250 frames (75 seconds at 30fps)
- **Language**: Brazilian Portuguese
- **Audio**: Corporate/uplifting background music (to be added separately)
- **Messaging**: Text overlays only, no voiceover

## Key Messages (PT-BR)

1. Hook: "Gestão escolar nunca foi tão simples"
2. Problem: "Planilhas. Papéis. Retrabalho." / "Horas perdidas em tarefas manuais"
3. Transition: "Conheça o Anuá"
4. Dashboard: "Tudo em um só lugar" / "Visão completa em tempo real"
5. AI: "IA que trabalha por você" / "Identifique riscos antes que aconteçam"
6. CTA: "Agende uma demonstração" / "anuaapp.com.br"

## Device Framing

Floating screens on gradient/abstract background - cinematic style, no browser chrome.
